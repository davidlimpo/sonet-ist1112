 ...
 * @version 1.0
 */
public class Notas extends Publicacao implements Serializable{
	 ...
	 *            o conteudo.
	 */
	public Notas(RedeSocial s, int id, int owner, String legend, String content){
	...
	public String toString(){
		return Message.typeNote() + super.toString(); 
	}
}
